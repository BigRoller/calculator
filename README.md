...
## Дата создания: декабрь 2023 года

Данная программа содержит в себе 5 модулей: 
1. калькулятор;
2. просмотр расписания;
3. преобразование целых положительных двухзначных чисел в слова;
...
3. Возможность преобразования целых положительных двухзначных чисел в слова.
...
3. Как пользователь, я хочу иметь возможность преобразовать целое положительное двухзначное число в словесную форму, чтобы было удобно работать с числами в текстовом виде.
