...
3. преобразование целых положительных двузначных чисел в слова;
...
3. Возможность преобразования целых положительных двузначных чисел в слова.
...
3. Как пользователь, я хочу иметь возможность преобразовать целое положительное двузначное число в словесную форму, чтобы было удобно работать с числами в текстовом виде.
